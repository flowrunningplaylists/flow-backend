...
class ActivitiesApi(object):
    ...
    def create_activity(self, name, sport_type, start_date_local, elapsed_time, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_activity(name, sport_type, start_date_local, elapsed_time, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str name: The name of the activity. (required)
        :param str sport_type: Sport type of activity. For example - Run, MountainBikeRide, Ride, etc. (required)
        :param datetime start_date_local: ISO 8601 formatted date time. (required)
        :param int elapsed_time: In seconds. (required)
        :param str type: Type of activity. For example - Run, Ride etc.
        ...
        if kwargs.get('async_req'):
            return self.create_activity_with_http_info(name, sport_type, start_date_local, elapsed_time, **kwargs)  # noqa: E501
        else:
            (data) = self.create_activity_with_http_info(name, sport_type, start_date_local, elapsed_time, **kwargs)  # noqa: E501
            return data

    def create_activity_with_http_info(self, name, sport_type, start_date_local, elapsed_time, **kwargs):  # noqa: E501
        """Create an Activity  # noqa: E501

        Creates a manual activity for an athlete, requires activity:write scope.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_activity_with_http_info(name, sport_type, start_date_local, elapsed_time, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['name', 'sport_type', 'start_date_local', 'elapsed_time', 'type', 'description', 'distance', 'trainer', 'commute']  # noqa: E501
        ...
        if ('sport_type' not in params or
                params['sport_type'] is None):
            raise ValueError("Missing the required parameter `sport_type` when calling `create_activity`")  # noqa: E501
        ...
        if 'sport_type' in params:
            form_params.append(('sport_type', params['sport_type']))  # noqa: E501
    ...
    def get_comments_by_activity_id(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the activity. (required)
        :param int page: Deprecated. Prefer to use after_cursor.
        :param int per_page: Deprecated. Prefer to use page_size.
        :param int page_size: Number of items per page. Defaults to 30.
        :param str after_cursor: Cursor of the last item in the previous page of results, used to request the subsequent page of results.  When omitted, the first page of results is fetched.
        :return: list[Comment]
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_comments_by_activity_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'page', 'per_page', 'page_size', 'after_cursor']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'after_cursor' in params:
            query_params.append(('after_cursor', params['after_cursor']))  # noqa: E501
