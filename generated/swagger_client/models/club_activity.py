...
class ClubActivity(object):
    ...
    def __init__(self, athlete=None, name=None, distance=None, moving_time=None, elapsed_time=None, total_elevation_gain=None, type=None, sport_type=None, workout_type=None):  # noqa: E501
